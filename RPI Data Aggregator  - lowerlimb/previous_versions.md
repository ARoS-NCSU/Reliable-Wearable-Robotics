...
**Compare data collection system IMU to another IMU data for sanity testing**
  ...
  * General view Accelerometer:
      ![alt text](https://github.ncsu.edu/aros/ARoS-Docs/blob/master/Reports/Rafael%20da%20Silva/ReportAug24th/IMUraspi_comparison1.png)
  * Zoom in:
      ![alt text](https://github.ncsu.edu/aros/ARoS-Docs/blob/master/Reports/Rafael%20da%20Silva/ReportAug24th/IMUraspi_comparison1_zoom.png)
  * General view Gyroscope:
      ![alt text](https://github.ncsu.edu/aros/ARoS-Docs/blob/master/Reports/Rafael%20da%20Silva/ReportAug24th/IMUraspi_comparison2.png)
  * Zoom in:
      ![alt text](https://github.ncsu.edu/aros/ARoS-Docs/blob/master/Reports/Rafael%20da%20Silva/ReportAug24th/IMUraspi_comparison2_zoom.png)
